<%@ Page Title="Division List | Solar Smart" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="DivisionMaster.aspx.cs" Inherits="Portal.SolarSmart.Settings.DivisionMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Division List</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">Division Name <span class="text-danger">*</span></label><br />
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <a href="/Settings/DivisionMaster.aspx" class="btn btn-secondary">Cancel</a>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <asp:LinkButton ID="btnadd" runat="server" class="btn btn-success float-right" OnClick="btnadd_Click"><i class="fas fa-save"  style="margin-right:8px"></i> Add Division</asp:LinkButton>
                  </div>
