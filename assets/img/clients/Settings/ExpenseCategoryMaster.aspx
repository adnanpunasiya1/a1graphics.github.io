<%@ Page Title="ExpenseCategory List | Solar Smart" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="ExpenseCategoryMaster.aspx.cs" Inherits="Portal.SolarSmart.Settings.ExpenseCategoryMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">ExpenseCategory List</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/Dashboard/AccessDashboard">Home</a></li>
            <li class="breadcrumb-item active">ExpenseCategory List</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
  ...
  <script>
    ...
    function CheckAlreadyExsist() {
      try {
        ...
        var CategoryName = $("#ContentPlaceHolder1_txtname").val();
        if ($("#ContentPlaceHolder1_txtname").val().length != 0) {
          $.ajax({
            type: "POST",
            url: "ExpenseCategoryMaster.aspx/CheckExpenseCategoryName",
            ...
            success: function (Response) {
              var res = Response.d;
              if (res == "1") {
                DisplayToast("!", "" + CategoryName + " already exsist .", "");
          ...
          DisplayToast("  ", "please Enter CategoryName", "error");
          return;
        }
      } catch (exp) {
        console.log(exp);
